      ...
      <div className="mx-auto w-full max-w-[1000px] px-6 sm:px-8 lg:px-10">
        <div className="flex items-end justify-between py-4">
          ...
          >
            ...
            <p className="mt-0 w-full text-left text-lg font-bold tracking-tight text-[#0F1C2E]">
              Flonancial
            </p>
          </Link>
          ...
          <div className="hidden flex-col items-center gap-2 sm:flex">
            ...
            <p className="text-xs font-medium text-[#0F1C2E]">
              Making Tax Digital becomes mandatory for income over £50,000
              (06/04/26) in{" "}
              <span className="font-bold text-[#2E88D0]">
                {daysToMtd50k} days
              </span>
            </p>

            <p className="text-xs font-medium text-[#0F1C2E]">
              Next quarterly submission deadline (05/05/26) in{" "}
              <span className="font-bold text-[#2E88D0]">
                {daysToDeadline} days
              </span>
            </p>
            ...
            <p className="text-xs font-medium text-[#0F1C2E]">
              Making Tax Digital becomes mandatory for income over £30,000
              (06/04/27) in{" "}
              <span className="font-bold text-[#2E88D0]">
                {daysToMtd30k} days
              </span>
          ...
          {loggedIn ? (
            <div className="flex flex-col items-end gap-1">
              ...
              <Link
                href="/dashboard"
                className="text-lg font-bold tracking-tight text-[#0F1C2E] transition hover:opacity-75"
              >
                Dashboard
              </Link>
            </div>
