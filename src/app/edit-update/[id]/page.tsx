        ...
        <div className="rounded-2xl border border-[#B8D0EB] bg-[#CCE0F5] p-5 sm:p-6">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              ...
              <p className="mt-3 text-sm leading-6 text-[#5A7896]">Edit figures for this update before sending them on.</p>
            </div>
          ...
          {loading ? (
            <p className="mt-6 text-sm text-[#5A7896]">Loading update...</p>
          ) : notFound ? (
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="mt-6 max-w-xl space-y-4">
                ...
                <p className="text-xs leading-5 text-[#5A7896]">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div>
                    ...
                    <input id="turnover" type="number" min="0" step="0.01" placeholder="0.00" value={turnover} onChange={(e) => setTurnover(e.target.value)}
                      ...
                      className="w-full rounded-xl border border-[#B8D0EB] bg-white px-4 py-3 text-[#0F1C2E] outline-none transition placeholder:text-[#5A7896] focus:border-[#2E88D0] disabled:opacity-60" />
                  </div>
                  <div>
