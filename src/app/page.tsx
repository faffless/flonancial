...
export default function HomePage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-gradient-to-b from-[#E8F0FA] via-[#F0F5FB] to-white text-[#0F1C2E]">
      <img src="/wave2.png" alt="" aria-hidden="true" className="pointer-events-none absolute left-1/2 top-0 z-0 w-[1400px] max-w-none -translate-x-1/2 opacity-[0.25]" style={{ maskImage: "linear-gradient(to bottom, black 90%, transparent 100%)", WebkitMaskImage: "linear-gradient(to bottom, black 90%, transparent 100%)" }} />
