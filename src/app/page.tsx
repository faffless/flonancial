...
const faqs = [
  ...
  { q: "Is Flonancial free?", a: "Yes — Flonancial is completely free. No card required, no hidden fees. Whether you're a sole trader, landlord, or an accountant filing on behalf of clients, there's nothing to pay." },
...
export default function HomePage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-gradient-to-b from-[#E8F0FA] via-[#F0F5FB] to-white text-[#0F1C2E]">
      <img src="/wave2.png" alt="" aria-hidden="true" className="pointer-events-none absolute left-1/2 top-0 z-0 w-[1400px] max-w-none -translate-x-1/2 opacity-[0.06]" style={{ maskImage: "linear-gradient(to bottom, black 90%, transparent 100%)", WebkitMaskImage: "linear-gradient(to bottom, black 90%, transparent 100%)" }} />
      <img src="/wave3.png" alt="" aria-hidden="true" className="pointer-events-none absolute left-1/2 top-[800px] z-0 w-[1400px] max-w-none -translate-x-1/2 opacity-[0.25]" style={{ maskImage: "linear-gradient(to bottom, transparent 0%, black 10%, black 90%, transparent 100%)", WebkitMaskImage: "linear-gradient(to bottom, transparent 0%, black 10%, black 90%, transparent 100%)" }} />
                        ...
                        <table className="w-full border-collapse text-xs">
                          <thead className="sticky top-0 z-10">
                            <tr className="bg-[#DEE9F8]">
                              <th scope="col" className="w-8 border-b border-r border-[#B8D0EB] px-2 py-1.5 text-center text-[10px] font-medium text-[#2E4A63]" />
                              {Array.from({ length: maxCols }, (_, c) => (
                                <th key={c} scope="col" className="min-w-[80px] border-b border-r border-[#B8D0EB] px-2 py-1.5 text-center text-[10px] font-medium text-[#2E4A63]">
